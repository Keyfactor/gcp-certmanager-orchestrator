...
using Keyfactor.Extensions.Orchestrator.GcpCertManager.Jobs;
            ...
            if (args.Length == 0)
            {
                ...
                switch (input)
                {
                    ...
                    case "Management":
                        ...
                        var mapEntryName = Console.ReadLine();
                        Console.WriteLine("Scope DEFAULT or EDGE_CERT");
                        ...
                        if (mgmtType == "Add")
                        {
                            ...
                            var jobConfiguration = GetJobConfiguration(privateKeyPwd, overWrite,
                                alias,mapName,mapEntryName,scope,location);
                        ...
                        if (mgmtType == "Remove")
                        {
                            ...
                            var mgmt = new Management(logger);
                            var jobConfig = GetRemoveJobConfiguration(privateKeyPwd, overWrite, alias, mapName, mapEntryName, scope, location);
